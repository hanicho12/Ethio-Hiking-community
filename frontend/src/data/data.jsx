...
export const next = [
    ...
    // },
    {
        ...
        urls: ['https://res.cloudinary.com/dzyara8uc/image/upload/v1738383543/danakil6_kuakak.jpg','https://res.cloudinary.com/dzyara8uc/image/upload/v1738383530/danakil15_jfg7qy.jpg','https://res.cloudinary.com/dzyara8uc/image/upload/v1738383533/danakil3_tywhko.jpg','https://res.cloudinary.com/dzyara8uc/image/upload/v1738383513/danakil11_fuocmk.jpg','https://res.cloudinary.com/dzyara8uc/image/upload/v1738383534/danakil5_wrmy8b.jpg','https://res.cloudinary.com/dzyara8uc/image/upload/v1738383513/danakil12_zwranz.jpg','https://res.cloudinary.com/dzyara8uc/image/upload/v1738383512/danakil10_zbymwk.jpg','https://res.cloudinary.com/dzyara8uc/image/upload/v1738383542/danakil9_gelzbb.jpg','https://res.cloudinary.com/dzyara8uc/image/upload/v1738383529/danakil4_uzmcrs.jpg','https://res.cloudinary.com/dzyara8uc/image/upload/v1738383542/danakil8_wuw451.jpg','https://res.cloudinary.com/dzyara8uc/image/upload/v1738383569/danakil13_lppxul.jpg','https://res.cloudinary.com/dzyara8uc/image/upload/v1738383517/danakil14_zplkr3.jpg'],
        day: 'Every weekend in March 2025',
        chooseDate: ['Mar 7-9','Mar 15-17','Mar 21-23','Mar 29-31'] ,
        ...
        itinerary:['Arrive in Semera via a flight from Addis Ababa, have breakfast, and drive to Lake Afdera to explore local salt farms, swim in the salt lake, and relax in natural hot springs. After lunch at a local restaurant, continue the journey toward Erta Ale, stopping for scenic desert views. In the evening, hike to the caldera for stunning views of the lava lake, followed by dinner under the stars and overnight camping at Erta Ale.', 'Start with a sunrise hike to Erta Ale’s caldera for breathtaking daylight views, followed by breakfast at the campsite. After packing up, drive towards Hamadela, taking in the scenic desert landscapes and enjoying a picnic lunch. Arrive in Hamadela in time for a stunning desert sunset, then have dinner and camp overnight.', 'Take an early drive to Dallol to witness the stunning sulfur formations at sunrise, then explore bubbling geothermal fields, salt mountains, and vibrant landscapes. Visit the Asale Salt Flats to see traditional salt mining and camel caravans before returning to Hamadela for lunch. Finally, drive to Mekele for an evening flight back to Addis Ababa.'],
    ...
    },
    {
        ...
        day: 'Every weekend in April 2025',
        chooseDate: ['Apr 4-6','Apr 11-13','Apr 18-20','Apr 25-27'],
        location: 'North East of Addis Ababa',
        elevation: 'about 125 m (410 ft) below sea level',
        highlights: 'Guided tour, meals, transportation',
        costDetail: 'Round-trip flights, transportation by land cruisers, meals, water/tea/coffee, camping gear, entrance fees, and local guides.',
